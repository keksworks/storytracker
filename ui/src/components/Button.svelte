...
<style global>
  .btn {
    @apply border border-transparent rounded-md text-center inline-flex active:opacity-80
      focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-opacity-75
