<script lang="ts">
  ...
  import type {Project, ProjectMemberRequest, ProjectMemberUser} from 'src/api/types'
  import api from 'src/api/api'
  import {showToast} from 'src/stores/toasts'

  export let project: Project
  export let member: ProjectMemberRequest
  ...
  async function submit() {
    onsaved(await api.post<ProjectMemberUser>(`projects/${project.id}/members`, member))
